...
<script>
  /* eslint-disable */
    import Vue from 'vue';
    var elementResizeDetectorMaker = require('element-resize-detector').default;

    import {bottom, compact, getLayoutItem, moveElement, validateLayout} from 'vue-grid-layout';
